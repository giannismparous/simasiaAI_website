...
export const extraUiEl = {
  ...
  aboutSection: {
    ...
    team: [
      ...
      { id: 'giannis', name: 'Γιάννης Μπαρούς', role: 'Co-founder & CTO' },
  ...
  teamPage: {
    ...
    team: [
      ...
      { id: 'giannis', name: 'Γιάννης Μπαρούς', role: 'Co-founder & CTO', shortBio: 'Υποψήφιος Διδάκτωρ Πληροφορικής (San Francisco), ειδικός σε ασφάλεια δεδομένων και RAG.', bio: 'Ο Γιάννης ηγείται του τεχνολογικού σχεδιασμού και των υποδομών της SimasiaAI. Είναι Υποψήφιος Διδάκτωρ (PhD candidate) στην Επιστήμη Υπολογιστών με έδρα το Σαν Φρανσίσκο, με εξειδίκευση σε συστήματα ιδιωτικότητας, ασφάλεια δεδομένων και αξιόπιστες υποδομές λογισμικού.', skills: ['Full Stack Development', 'AI Security & Privacy', 'RAG Architectures', 'Infrastructure Scaling'] },
...
export const extraUiEn = {
  ...
  aboutSection: {
    ...
    team: [
      ...
      { id: 'giannis', name: 'Giannis Barous', role: 'Co-founder & CTO' },
  ...
  teamPage: {
    ...
    team: [
      ...
      { id: 'giannis', name: 'Giannis Barous', role: 'Co-founder & CTO', shortBio: 'PhD candidate in Computer Science (San Francisco), specialist in data security and RAG architectures.', bio: 'Giannis leads the technological design and infrastructure of SimasiaAI. He is a PhD candidate in Computer Science based in San Francisco, specializing in privacy systems, data security, and reliable software infrastructure.', skills: ['Full Stack Development', 'AI Security & Privacy', 'RAG Architectures', 'Infrastructure Scaling'] },
