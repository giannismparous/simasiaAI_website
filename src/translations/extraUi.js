...
export const extraUiEl = {
  ...
  pageTitles: {
    ...
    newsletter: 'Newsletter · SimasiaAI',
  ...
  footer: {
    ...
    newsletterTitle: 'Εγγραφή στο Newsletter',
    newsletterSub: 'Λαμβάνετε πρώτοι τα νέα τεύχη και τις πρωτοβουλίες της SimasiaAI για την προσβάσιμη υγεία και τεχνολογία.',
    newsletterPlaceholder: 'Το email σας...',
    newsletterButton: 'Εγγραφή',
    newsletterSubmitting: 'Εγγραφή...',
    newsletterSuccess: 'Ευχαριστούμε για την εγγραφή σας!',
    newsletterError: 'Παρακαλούμε εισάγετε ένα έγκυρο email.',
  ...
  newsPage: {
    ...
    newsletterBannerTag: 'ΕΠΙΣΗΜΟ NEWSLETTER',
    newsletterBannerTitle: 'Τεύχος 01: «Με τις οργανώσεις ασθενών κοντά στις ευάλωτες κοινωνικές ομάδες»',
    newsletterBannerCta: 'Διαβάστε το Τεύχος →',
  ...
  newsletterPage: {
    badge: 'ΠΕΡΙΟΔΙΚΗ ΕΚΔΟΣΗ · ΤΕΥΧΟΣ 01',
    heroTitle: 'SimasiaAI Newsletter',
    heroSub: 'Επίσημο δελτίο περιοδικής ενημέρωσης για την ανθρωποκεντρική Τεχνητή Νοημοσύνη και τη συνδημιουργία με τις οργανώσεις ασθενών.',
    masthead: {
      volume: 'Τόμος I · Τεύχος 1 · Φθινόπωρο 2026',
      publisher: 'Εκδόσεις SimasiaAI · Αθήνα',
      classification: 'Ψηφιακοί Πλοηγοί & Κοινωνική Ένταξη',
      editionBadge: 'Πρωτότυπη Έκδοση Τεύχους',
      switchEditionEl: 'Ελληνική Έκδοση',
      switchEditionEn: 'English Edition',
    },
    viewer: {
      heading: 'Προεπισκόπηση Εντύπου Τεύχους',
      subheading: 'Ξεφυλλίστε το πρωτότυπο δισέλιδο δελτίο ή επιλέξτε την αγγλική έκδοση.',
      twoPages: 'Δισέλιδο Folio',
      page1: 'Σελίδα 1',
      page2: 'Σελίδα 2',
      enlarge: 'Μεγέθυνση σελίδας',
      downloadPdfEl: 'Λήψη PDF (Ελληνικά)',
      downloadPdfEn: 'Download',
      closeModal: 'Κλείσιμο',
    },
    issue1: {
      eyebrow: 'Τρεις νέοι ψηφιακοί βοηθοί από τη SimasiaAI',
      title: 'ΜΕ ΤΙΣ ΟΡΓΑΝΩΣΕΙΣ ΑΣΘΕΝΩΝ ΚΟΝΤΑ ΣΤΙΣ ΕΥΑΛΩΤΕΣ ΚΟΙΝΩΝΙΚΕΣ ΟΜΑΔΕΣ',
      lead: 'Πρόσφατα παρουσιάστηκαν στο κοινό τρεις νέοι ψηφιακοί βοηθοί της SimasiaAI για ευάλωτες κοινωνικές ομάδες, οι οποίοι σχεδιάστηκαν σε στενή συνεργασία με οργανώσεις ασθενών:',
      assistantsTitle: 'Σε στενή συνεργασία με τις οργανώσεις ασθενών',
      assistants: [
        {
          id: 'poamskp',
          name: 'ΣΚΠ-i',
          partner: 'Πανελλήνια Ομοσπονδία Ατόμων με Σκλήρυνση Κατά Πλάκας (ΠΟΑμΣΚΠ)',
          desc: 'Ψηφιακός βοηθός για έγκυρη πληροφόρηση, διαθέσιμες παροχές, υπηρεσίες και δικαιώματα των ατόμων με πολλαπλή σκλήρυνση και των φροντιστών τους.',
          logo: '/logos/poamskp.png',
          link: 'https://www.poamskp.gr',
        },
        {
          id: 'kapa3',
          name: 'Μυρτώ',
          partner: 'Κέντρο Καθοδήγησης Καρκινοπαθών - Κ3',
          desc: 'Ψηφιακή πλοηγός για καρκινοπαθείς και φροντιστές, συγκεντρώνοντας όλες τις διάσπαρτες πληροφορίες παροχών και υποστήριξης με γλώσσα φροντιστική.',
          logo: '/logos/kapa3.png',
          link: 'https://www.kapa3.gr',
        },
        {
          id: 'bpan',
          name: 'BPAN Companion',
          partner: 'Ήρωες της BPAN',
          desc: 'Βοηθός σε 60 γλώσσες για τη σπάνια νευροεκφυλιστική νόσο BPAN (Beta-Propeller protein-Associated Neurodegeneration), υποστηρίζοντας οικογένειες διεθνώς.',
          logo: '/logos/bepan.png',
          link: 'https://bpanheroes.gr',
        },
      ],
      features: [
        {
          num: 'I',
          title: 'Έγκυρη Πληροφόρηση & Δικαιώματα',
          text: 'Οι βοηθοί αυτοί παρέχουν έγκυρη πληροφόρηση αναφορικά με τις συγκεκριμένες ασθένειες αλλά και για τις διαθέσιμες παροχές, υπηρεσίες και τα δικαιώματα των ασθενών.',
        },
        {
          num: 'II',
          title: 'Ενιαίος Κόμβος Συγκέντρωσης',
          text: 'Αποτελούν έναν πολύτιμο κόμβο συγκέντρωσης διάσπαρτων πληροφοριών οι οποίες μεταφέρονται σε κάθε ενδιαφερόμενο πρόσωπο με γλώσσα φροντιστική και συμπεριληπτική.',
        },
        {
          num: 'III',
          title: 'Αναγνώριση Συναισθήματος & Διαχείριση Κρίσεων',
          text: 'Επιπλέον, οι ψηφιακοί αυτοί βοηθοί αναγνωρίζουν συναισθήματα και μπορούν να εντοπίσουν εάν ένα πρόσωπο βρίσκεται σε μια στιγμή κρίσης που απαιτεί άμεση ανθρώπινη παρέμβαση, οπότε και το κατευθύνουν ανάλογα.',
        },
      ],
      sectionCoCreationTitle: 'Συνδημιουργία με τις Οργανώσεις & τους Ασθενείς',
      coCreationText1: 'Και οι τρεις βοηθοί φτιάχτηκαν σε στενή, συστηματική αλληλεπίδραση με τις αντίστοιχες οργανώσεις ασθενών, οι οποίες συμμετείχαν ενεργά σε όλα τα στάδια του σχεδιασμού. Η SimasiaAI δόμησε το πλαίσιο της συνεργασίας και η ΠΟΑμΣΚΠ, το Κ3 και οι «Ήρωες της BPAN» πρόσφεραν την ανεκτίμητη γνώση τους στον εντοπισμό έγκυρων πηγών – επιστημονικών, νομικών, υπηρεσιακών εγκυκλίων – συμβάλλοντας ενεργά στη σύνθεση του περιεχομένου.',
      coCreationText2: 'Μέλη των οργανώσεων – άνθρωποι με προσωπική εμπειρία της νόσου ή φροντιστές – έκαναν δοκιμές, εντόπισαν κενά ή ανακρίβειες, πρότειναν διορθώσεις, βοήθησαν να διαμορφωθεί ο τόνος και το λεξιλόγιο και συνεισέφεραν τη μακρόχρονη εμπειρία τους διασφαλίζοντας ότι οι πληροφορίες ανταποκρίνονται στην πραγματική εμπειρία και τις ανάγκες των ασθενών και των φροντιστών τους.',
      sectionSafeguardsTitle: 'Ασφάλεια, Όρια & Προσβασιμότητα',
      safeguardsText: 'Η SimasiaAI ανταποκρίθηκε σε κάθε παρατήρηση, έβαλε όρια στους βοηθούς ώστε να δίνουν μόνο έγκυρες απαντήσεις, τους εφοδίασε με δυνατότητες προσβασιμότητας, αναγνώριση συναισθήματος και οδηγίες για στιγμές κρίσης, τους προσάρμοσε στις ειδικότερες στοχεύσεις κάθε οργάνωσης.',
      sectionImpactTitle: 'Πολλαπλασιάζοντας το Κοινωνικό Αποτύπωμα',
      impactText: 'Με αυτόν τον τρόπο ο πλούτος της γνώσης που έχουν για τις κοινότητές τους οι οργανώσεις ασθενών δεν δεσμεύεται πια από τους περιορισμένους ανθρώπινους πόρους τους. Οι ψηφιακοί βοηθοί, δημιουργημένοι ακριβώς στα μέτρα τους, είναι διαθέσιμοι όλο το εικοσιτετράωρο πολλαπλασιάζοντας το πολύτιμο κοινωνικό τους αποτύπωμα.',
    },
    colophon: {
      title: 'Κολοφώνας & Εγγραφή',
      text: 'Το SimasiaAI Newsletter εκδίδεται περιοδικά. Για να λαμβάνετε τα επόμενα τεύχη, εγγραφείτε στο πεδίο εγγραφής στο υποσέλιδο της ιστοσελίδας.',
      archiveNote: 'Όλα τα τεύχη αρχειοθετούνται με ανοικτή πρόσβαση.',
    },
  },
  teamPage: {
    eyebrow: 'SimasiaAI',
...
export const extraUiEn = {
  ...
  footer: {
    ...
    newsletterSub: 'Be the first to receive new issues and SimasiaAI initiatives for accessible health and technology.',
  ...
  forbesHero: {
    words: ['The', 'Human', 'Standard'],
    ariaLabel: 'The Human Standard',
    humanWord: 'Standard',
  ...
  newsPage: {
    ...
    newsletterBannerTag: 'OFFICIAL NEWSLETTER',
    newsletterBannerTitle: 'Issue 01: "With patient organizations close to vulnerable social groups"',
    newsletterBannerCta: 'Read Issue →',
    filterLabel: 'Filter:',
    filterAll: 'All',
    filterNews: 'News',
  ...
  newsletterPage: {
    badge: 'Periodical Publication · Issue 01',
    heroTitle: 'SimasiaAI Newsletter',
    heroSub: 'Official periodical bulletin on human-centric Artificial Intelligence and co-creation with patient organizations.',
    masthead: {
      volume: 'Vol. I · Issue 1 · Autumn 2026',
      publisher: 'SimasiaAI Publications · Athens',
      classification: 'Digital Navigators & Social Inclusion',
      editionBadge: 'Original Issue Edition',
      switchEditionEl: 'Greek Edition',
      switchEditionEn: 'English Edition',
    },
    viewer: {
      heading: 'Preview',
      subheading: 'Browse the original two-page bulletin or select the English edition.',
      twoPages: 'Two-Page Folio',
      page1: 'Page 1',
      page2: 'Page 2',
      enlarge: 'Enlarge page',
      downloadPdfEl: 'Download PDF (Greek)',
      downloadPdfEn: 'Download',
      closeModal: 'Close',
    },
    ...
    issueMeta: {
      ...
      date: 'September 2026',
      readTime: '3 min read',
      theme: 'Healthcare & Social Inclusion',
    },
    issue1: {
      eyebrow: 'Three new digital assistants from SimasiaAI',
      title: 'WITH PATIENT ORGANIZATIONS CLOSE TO VULNERABLE SOCIAL GROUPS',
      lead: 'Three new digital assistants from SimasiaAI for vulnerable social groups were recently presented to the public, co-designed in close collaboration with patient organizations:',
      assistantsTitle: 'In close collaboration with patient organizations',
      assistants: [
        {
          id: 'poamskp',
          name: 'SKP-i',
          partner: 'Panhellenic Federation of Persons with Multiple Sclerosis (POAmSKP)',
          desc: 'Digital assistant for authoritative information, available benefits, services, and rights for people with multiple sclerosis and their caregivers.',
          logo: '/logos/poamskp.png',
          link: 'https://www.poamskp.gr',
        },
        {
          id: 'kapa3',
          name: 'Myrto',
          partner: 'Cancer Guidance Center - K3',
          desc: 'Digital navigator for cancer patients and caregivers, consolidating all dispersed benefit and support information with caring language.',
          logo: '/logos/kapa3.png',
          link: 'https://www.kapa3.gr',
        },
        {
          id: 'bpan',
          name: 'BPAN Companion',
          partner: 'Heroes of BPAN',
          desc: 'Assistant in 60 languages for the rare neurodegenerative condition BPAN (Beta-Propeller protein-Associated Neurodegeneration), supporting families globally.',
          logo: '/logos/bepan.png',
          link: 'https://bpanheroes.gr',
        },
      ],
      features: [
        {
          title: 'Authoritative Information & Rights',
          text: 'The assistants provide authoritative information regarding specific diseases as well as available provisions, services, and patient rights.',
        },
        {
          title: 'Unified Information Hub',
          text: 'They form a valuable hub for dispersed information, conveyed to every interested person with caring and inclusive language.',
        },
        {
          title: 'Emotion Recognition & Crisis Management',
          text: 'They recognize emotions and identify when a person is experiencing a crisis requiring immediate human intervention, directing them appropriately.',
        },
      ],
      coCreationTitle: 'Co-Creation with Organizations & Patients',
      coCreationText1: 'All three assistants were built through close, systematic interaction with patient organizations, who actively participated in all stages of design. SimasiaAI established the collaboration framework, and POAmSKP, K3, and the "Heroes of BPAN" contributed their invaluable knowledge in identifying authoritative sources—scientific, legal, and operational circulars—actively participating in content synthesis.',
      coCreationText2: 'Organization members—people with lived experience of the condition or caregivers—conducted tests, spotted gaps or inaccuracies, suggested corrections, helped shape the tone and vocabulary, and contributed their long-standing experience to ensure that the information reflects real-world experiences and the needs of patients and caregivers.',
      safeguardsTitle: 'Safety, Guardrails & Accessibility',
      safeguardsText: 'SimasiaAI responded to every observation, established strict guardrails so the assistants deliver only authoritative answers, equipped them with accessibility features, emotion recognition, and crisis guidelines, and tailored them to each organization\'s specific priorities.',
      impactTitle: 'Multiplying Social Impact',
      impactText: 'In this way, the wealth of knowledge patient organizations possess for their communities is no longer bound by limited human resources. The digital assistants, tailored precisely to their needs, are available 24/7, multiplying their invaluable social impact.',
    },
    subscribeSection: {
      title: 'Stay connected with upcoming issues',
      subtitle: 'Subscribe to receive future issues of the SimasiaAI Newsletter directly in your inbox.',
      button: 'Subscribe to Newsletter',
      disclaimer: 'We respect your privacy. You can unsubscribe at any time.',
    },
    pdfViewer: {
      title: 'Original Issue #1 Publication',
