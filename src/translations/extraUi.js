...
export const extraUiEn = {
  ...
  newsletterPage: {
    badge: 'Issue 01 · September 2026',
    heroTitle: 'SimasiaAI Newsletter',
    heroSub: 'Together with patient organizations, we bring responsible Artificial Intelligence to the service of vulnerable social groups.',
    readIssue: 'Read Issue #1',
    downloadPdf: 'Download PDF (Original)',
    issueMeta: {
      number: 'Issue 01',
      date: 'September 2026',
      readTime: '3 min read',
