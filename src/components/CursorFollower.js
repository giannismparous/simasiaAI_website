...
const DARK_BG_SELECTORS = ['.fh-section','.scp-hero','.scp-cta','.ap-hero','.cp-hero','.bdp-hero','.demo-hero','.site-footer','.solutions-hero','.tp-hero','.np-hero','.svc-hero','.svc-empathy-banner','.svc-final-cta','.enterprise-cta'];
