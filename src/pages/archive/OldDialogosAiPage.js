/**
 * Archived snapshot of the DialogosAI product page (Aug 2026).
 * Not linked publicly — route: /archive/old-dialogos-ai
 */
...
const OldDialogosAiPage = () => {
  ...
  return (
    <div className="scp-page">
      <ArchivePageGuard label="old-dialogos-ai" />
      {/* Hero */}
...
export default OldDialogosAiPage;
